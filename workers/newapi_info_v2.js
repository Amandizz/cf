addEventListener('fetch', event => {
  ...
  <div class="container">
      ...
      <div class="input-group">
           <label for="api-version">API版本:</label>
  ...
  <script>
      ...
      function getBalance() {
          ...
          fetch(\`\${apiUrl}/\${apiVersion}/dashboard/billing/subscription\`, { headers })
              ...
              .then(data => {
                  ...
                  fetch(\`\${apiUrl}/\${apiVersion}/dashboard/billing/usage?start_date=\${startDate.toISOString().split('T')[0]}&end_date=\${endDate.toISOString().split('T')[0]}\`, { headers })
                      .then(response => response.json())
                      .then(billingData => {
      ...
      function getModels() {
          ...
          fetch(\`\${apiUrl}/\${apiVersion}/models\`, {
              headers: {
                  'Authorization': \`Bearer \${apiKey}\`,
                  'Content-Type': 'application/json'
              }
      ...
      function testModel(model) {
          ...
          fetch(\`\${apiUrl}/\${apiVersion}/chat/completions\`, {
              method: 'POST',
              headers: {
                  'Authorization': \`Bearer \${apiKey}\`,
                  'Content-Type': 'application/json'
